<template>
  <div class="bottom-left-chart-1">
    <div class="header-name">系统稳定率</div>
        ...
        series: [
          {
            type: 'pie',
            data: [
              { name: '网审系统', value: 93, radius: ['30%', '33%'] },
              { name: '认证系统', value: 65, radius: ['32%', '35%'] },
              { name: '事项系统', value: 32, radius: ['31%', '37%'] },
              { name: '好差评系统', value: 44, radius: ['31%', '32%'] },
